...
row1 = html.Div([
    ...
    html.Div([
        ...
        html.H5("What are the size of the training and testing sets?", style={'font-style':'italic', 'text-align':'center'}),
...
row2 = html.Div([
    ...
    html.Div([
        ...
        html.Br(),
        html.H5("About the Data", style={'font-style':'italic', 'text-align':'left'}),
        html.P('The dataset used for modeling is data collected from the thisjourneybus eBay store. It includes sales from Summer (June) 2017 to Summer (June) 2018.', style={'text-align':'left'}),
        ...
        html.P("The original dataset included a sale date feature. I chose to engineer a feature from sale date for the purpose of categorizing items based on the season in which they sold. Seasonality is often significant in retail sales.", style={'text-align':'center'}),
        ...
        html.P("The mean of the target variable, price, is approximately $42.78. It's not uncommon to use the mean to create a baseline model. This is what I did", style={'text-align':'center'}),
        ...
        html.P("Using 3-fold cross validation, the most optimal performing model is:", style={'text-align':'left'}),
