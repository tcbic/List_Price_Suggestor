...
row2 = html.Div([
    ...
    html.Div([
        ...
        html.P("I chose to engineer a feature from sale date for the purpose of categorizing items based on the season in which they sold. Each item fell into one of the four seasons, Summer, Fall, Winter or Spring."),
        html.H6("The final features included in the dataset used to train the model are:"),
        html.P("size - the size of the item sold", style={'font-style':'italic'}),
        html.P("style - the name of the specific lululemon athletica style", style={'font-style':'italic'}),
        html.P("item_specifcs - a descriptor of the item sold", style={'font-style':'italic'}),
        html.P("season - the season the item sold (i.e. Fall)", style={'font-style':'italic'}),
        html.Br(),
        ...
        html.P("The mean of the target variable, price, is approximately $42.78. I used the mean to create a baseline model. The primary purpose of creating a baseline is to establish a starting point to improve upon."),
        html.P("If we listed each item for $42.78, we would be off by $4.74 on average."),
        html.H5("Model Selection", style={'font-style':'italic'}),
        ...
        html.P("This model has a test MAE of $4.51 and shows an improvement of 23 cents over the baseline model."),
